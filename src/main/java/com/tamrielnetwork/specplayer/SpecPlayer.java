...
public final class SpecPlayer
	...
	public void onEnable() {
		Objects.requireNonNull(getCommand("spec"))
		       .setExecutor(new SpecPlayerCmd());
		messages = new Messages();
		Bukkit.getLogger()
		      .info("SpecPlayer v" + this.getDescription()
		                                 .getVersion() + " enabled");
		Bukkit.getLogger()
		...
		Bukkit.getLogger()
		      .info("See https://github.com/TamrielNetwork/SpecPlayer/blob/main/LICENSE for more details.");
	}
